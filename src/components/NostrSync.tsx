 ...
 *
 * NOTE: this app deliberately does NOT sync the NIP-65 relay list (kind 10002)
 * into `config.relayMetadata`. Here, `relayMetadata` is the *app relay list* —
 * the read set for the SIP-01 dashboard/explorer, owned by the site visitor and
 * editable in /settings — not the logged-in user's Nostr relay list. Importing
 * a user's NIP-65 list would clobber it.
 */
